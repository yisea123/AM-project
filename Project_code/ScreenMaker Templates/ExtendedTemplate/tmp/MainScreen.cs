    ...
    public class MainScreen : ABB.Robotics.ScreenMaker.Windows.Forms.ScreenForm
    {
        ...
        protected override void OnInstall(ABB.Robotics.ScreenMaker.Base.IScreenServices services)
        {
            if ((services.ApplicationVariables.Count == 0))
            {
                ...
                // newName
                // 
                ABB.Robotics.ScreenMaker.Base.ApplicationVariable newName = new ABB.Robotics.ScreenMaker.Base.ApplicationVariable("newName", "0", typeof(ABB.Robotics.Controllers.RapidDomain.Num));
                // 
                // Store variables
                // 
                services.ApplicationVariables.Add("newName", newName);
            }
