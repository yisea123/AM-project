function [contour_transform, TCP_traj, TCP_ornt] = coordinate_transform(Centroid, V, TCP)
% input:
...
%         axis equal
    ...
    for j = 1:size(contour,1)
        ...
        M_SlicingPlane2Welding =    [1, 0, 0, -contour(j,1);
            ...
            0, 0, 1, 0;
            0, 0, 0, 1];
        M_total = M_SlicingPlane2Welding * M_Tool2SlicingPlane;
